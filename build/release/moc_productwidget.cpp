...
#include "../../frontend/include/productwidget.h"
...
void ProductWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->editRequested((*reinterpret_cast< std::add_pointer_t<Product>>(_a[1]))); break;
        case 1: _t->removeRequested((*reinterpret_cast< std::add_pointer_t<Product>>(_a[1]))); break;
        case 2: _t->onEditProduct((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->onDeleteProduct((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ProductWidget::*)(Product )>(_a, &ProductWidget::editRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ProductWidget::*)(Product )>(_a, &ProductWidget::removeRequested, 1))
            return;
    }
}
...
// SIGNAL 0
void ProductWidget::editRequested(Product _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ProductWidget::removeRequested(Product _t1)
{
